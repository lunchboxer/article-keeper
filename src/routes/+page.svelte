...
<p>
  Students should include a heading for each entry. The heading should include
  the day and the title of the article. Labels for the book of knowledge can be
  printed from
  <a href="/bok-label.pdf">this PDF document</a>. A standard B5 size lined
  notebook is ideal.
</p>
